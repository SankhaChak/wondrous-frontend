...
const TaskDescriptionTextWrapper = ({ text }) => {
  ...
  return (
    <>
      ...
      {showButton && (
        <TaskDescriptionTextShowAll onClick={handleExpand}>
          <TaskDescriptionTextShowAllText>
            {isExpanded ? `Hide description` : `Show full description`}
          </TaskDescriptionTextShowAllText>
          <TaskDescriptionTextShowAllArrow isExpanded={isExpanded} />
        </TaskDescriptionTextShowAll>
      )}
    </>
  );
          ...
          <TaskModalCard>
            ...
            <TaskModalTaskData>
              ...
              <TaskSectionDisplayDivWrapper>
                ...
                {(fetchedTask?.githubIssue || fetchedTask?.githubPullRequest) && (
                  <GithubBlock>
